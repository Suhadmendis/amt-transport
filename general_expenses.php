<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><b>General Expenses</b></h3>
        </div>
        <form name= "form1" role="form" class="form-horizontal">
            ...
            <div class="box-body">
                ...
                <div class="form-group-sm">
                    ...
                    <a onclick="NewWindow('search_expenses.php?stname=gcode', 'mywin', '800', '700', 'yes', 'center');" class="btn btn-info btn-sm">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group-sm">
                        <label class="col-sm-2" for="c_code">Expense Ref</label>
                        <div class="col-sm-3">
                            <input type="text" placeholder=""  id="expense_ref" class="form-control  input-sm" disabled="">
                    ...
                    <div class="form-group"></div>
                    <div class="form-group-sm">
                        <label class="col-sm-2" for="c_code">Expense Category</label>


                        <div class="col-sm-3">
                            <select id="expense_category" class="form-control input-sm">

                                <option value="Water bill">Water bill</option>
                                <option value="Slt mobile bill">Slt mobile bill</option>
                                <option value="Electricity bill">Electricity bill</option>
                                <option value="Yard expenses">Yard expenses</option>
                    ...
                    <div class="form-group-sm">
                        ...
                        <div class="col-sm-1">
                            <input type="text" placeholder="Vehicle Ref"  id="vehicle_ref" class="form-control  hidden input-sm">
                        </div>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Vehicle Name"  id="vehicle_number" class="form-control hidden input-sm">
                        </div>
                    </div>
                    ...
                    <div class="form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input type="text" placeholder="" value="G"  id="entry_type" class="form-control hidden input-sm">
                        </div>
