<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><b>Vehicle Expenses</b></h3>
        </div>
        <form name= "form1" role="form" class="form-horizontal">
            ...
            <div class="box-body">
                ...
                <div class="form-group-sm">
                    ...
                    <a onclick="NewWindow('search_expenses.php?stname=vcode', 'mywin', '800', '700', 'yes', 'center');" class="btn btn-info btn-sm">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group-sm">
                        ...
                        <div class="col-sm-1">
                            <a href="" onclick="NewWindow('search_vehicle_master1.php?stname=code', 'mywin', '800', '700', 'yes', 'center');
                    ...
                    <div class="form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input type="text" placeholder="" value="V"  id="entry_type" class="form-control hidden input-sm">
                        </div>
