    ...
    <body class="hold-transition skin-red sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                <!-- Logo -->
                <a style="font-size: 12px;" href="home.php" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels --> <span class="logo-mini"><b></b></span> <!-- logo for regular state and mobile devices --> <span class="logo-lg"><b>Marketing</b></span> AMT</a>
